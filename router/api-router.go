...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/routing/config", middleware.UserAuth(), controller.GetRoutingConfig)
		...
		apiRouter.GET("/compliance/config", middleware.UserAuth(), controller.GetComplianceConfig)
	...
	apiRouter.POST("/user/epay/notify/alipay", anonymousRequestBodyLimit, controller.AlipayNotify)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.POST("/wechat/pay", middleware.CriticalRateLimit(), controller.RequestWechatPay)
				selfRoute.GET("/wechat/query", controller.WechatNativeQuery)
				selfRoute.GET("/alipay/query", controller.AlipayNativeQuery)
		...
		apiRouter.GET("/admin/audit-logs", middleware.AdminAuth(), controller.GetAdminAuditLogs)
