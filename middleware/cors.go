...
func CORS() gin.HandlerFunc {
	...
	config.AllowHeaders = []string{"Origin", "Content-Type", "Authorization", "X-Requested-With", "Accept", "X-Routing-Strategy", "X-Yuxin-Route"}
	config.ExposeHeaders = []string{"Content-Length", "X-Yuxin-Model", "X-Yuxin-Alias"}
