...
export type NavLink = BaseNavItem & {
  ...
  /**
   * When set, the sidebar item renders as an action button instead of a
   * navigation link (e.g. opening an in-page drawer). Clicking calls this
   * handler and does NOT navigate to url.
   */
  onClick?: () => void
  items?: never
  type?: never
